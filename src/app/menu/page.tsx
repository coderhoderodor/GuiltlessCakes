    ...
    <div>
      ...
      <section className="bg-gradient-to-b from-pink-50 to-white py-16 lg:py-24">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl lg:text-5xl font-bold text-neutral-800 mb-5">
              This Week&apos;s Menu
            </h1>
      ...
      {weeklyStory?.story_en && (
        <section className="py-10">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center bg-pink-50 rounded-2xl p-8">
      ...
      <section className="py-16 lg:py-24 bg-neutral-50">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl lg:text-3xl font-bold text-neutral-800 mb-10 text-center">
              How Ordering Works
            </h2>
